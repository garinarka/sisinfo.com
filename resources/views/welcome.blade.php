    ...
    <div class="font-sans antialiased dark:bg-black dark:text-white/50">
        <div class="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
            ...
            " />
                        ...
                        <div
                            class="flex flex-col items-start gap-6 p-6 overflow-hidden transition duration-300 bg-white rounded-lg shadow-lg ring-1 ring-gray-200 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-red-500 dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700">
                            <div class="relative flex items-center gap-6 lg:items-end">
                                <div class="flex items-start gap-6 lg:flex-col">
                                    <div
                                        class="flex items-center justify-center rounded-full size-12 shrink-0 bg-red-500/10 sm:size-16">
                                        <svg class="text-red-500 size-6" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                        ...
                        <div
                            class="flex flex-col items-start gap-6 p-6 overflow-hidden transition duration-300 bg-white rounded-lg shadow-lg ring-1 ring-gray-200 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-yellow-500 dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700">
                            <div class="relative flex items-center gap-6 lg:items-end">
                                <div class="flex items-start gap-6 lg:flex-col">
                                    <div
                                        class="flex items-center justify-center rounded-full size-12 shrink-0 bg-red-500/10 sm:size-16">
                    ...
                    <footer class="py-16 text-center text-black text-md dark:text-white/70">
                        &copy; {{ date('Y') }} <a class="hover:text-red-500 hover:underline" target="_blank"
